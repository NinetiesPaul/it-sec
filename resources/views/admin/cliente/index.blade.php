    ...
    <head>
        ...
        <script>
            ...
            $(document).ready(function(){
                $("#cadastrar_cliente_list").css('height', $("#cadastrar_cliente_form").css('height'));
        ...
        <div class="container">
            <div class="jumbotron text-center">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" id="cadastrar_cliente_form-tab" data-toggle="tab" href="#cadastrar_cliente_form" role="tab" aria-controls="home"
                           aria-selected="true">Cadastrar</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="cadastrar_cliente_list-tab" data-toggle="tab" href="#cadastrar_cliente_list" role="tab" aria-controls="profile"
                           aria-selected="false">Lista de Clientes</a>
                    </li>
                </ul>

                <div class="tab-content">
                    <div class="tab-pane fade show active" id="cadastrar_cliente_form" role="tabpanel" >
                        <p><strong>Cadastro de Cliente</strong></p>
                        <form action="/admin/cliente" method="post" role="form" class="form-horizontal " id="form-agente">
                            @csrf
                    ...
                    <div class="tab-pane fade show" id="cadastrar_cliente_list" role="tabpanel" >
                        ...
                        <table class="table">
                            ...
                            @foreach($usuarios as $usuario)
                                <tr>
                                    ...
                                    <td>{{$usuario->mail}}</td>
                                    <td>
                                        <a href="cliente/{{$usuario->usuario_id}}">editar</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
